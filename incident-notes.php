...
<HTML>
<HEAD>
  <META HTTP-EQUIV=Refresh CONTENT="15; URL=<?php print $_SERVER["PHP_SELF"]; if (isset($_GET["incident_id"])) print "?incident_id=".MysqlClean($_GET,"incident_id",20) ?>"> 
  <TITLE>Dispatch :: Incident Viewer</TITLE>
  <BASE target="_parent">
...
<font face="tahoma,ariel,sans">
  ...
  <tr>
     ...
     <tr bgcolor="darkgray">
     <?php if (isset($_COOKIE['incidents_show_creator'])) {
 ...
 <?php
   ...
   if (mysql_num_rows($result)) {
     while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
      ...
      echo "<tr>\n";
      echo "<td class=message><center>-</center>";
      echo "<td class=message><center>-</center>";
